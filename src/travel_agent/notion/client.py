...
from .config import SCHEMAS, DATABASES, normalize_id
from .types import parse_page_properties, build_page_properties
...
class NotionClient:
        ...
        for item in results.get("results", []):
            ...
            if title_array:
                ...
                if db_name == name:
                    ...
                    schema = {k: v.get("type") for k, v in properties.items()} if properties else None
    ...
    def update_page(self, page_id: str, data: dict, data_source_id: str | None = None) -> dict:
        """更新页面
